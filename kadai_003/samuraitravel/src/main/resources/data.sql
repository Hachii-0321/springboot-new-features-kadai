...
-- reviewsテーブル
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (1, 1, 1, 5, '部屋が綺麗で、快適に過ごせました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (2, 1, 2, 4, 'アクセスが良く、観光に快適でした。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (3, 1, 3, 4, 'スタッフが親切で、気持ちよく滞在できました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (4, 1, 4, 5, '駅から近く、便利でした。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (5, 1, 5, 4, '周辺の飲食店が充実していて、楽しめました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (6, 1, 6, 4, '宿泊費が手頃で、コストパフォーマンスが良かったです。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (7, 1, 7, 5, '静かな環境でゆっくり休めました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (8, 1, 8, 4, '施設内の設備が充実していました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (9, 1, 9, 5, 'WI-FIが快適で助かりました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (10, 1, 10, 4, '清潔感があり、気持ちよく滞在出来ました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (11, 1, 11, 5, '素晴らしい滞在でした。また利用したいです。');
INSERT IGNORE INTO reviews (id, house_id, user_id, rating, review_content) VALUES (12, 1, 12, 5, '大浴場の温泉が広く、清潔感がありゆっくり過ごせました。');
